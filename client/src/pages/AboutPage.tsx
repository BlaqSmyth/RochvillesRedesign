          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-6">
                Rochvilles & Co. Accountants is a professional accounting firm based in Ilford, Essex, 
                serving businesses and contractors across London and the surrounding areas.
              </p>
