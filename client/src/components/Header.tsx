  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b backdrop-blur-xl bg-background/95 shadow-lg transition-all duration-300" style={{ backdropFilter: 'blur(24px)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-28 items-center justify-between gap-4" style={{ marginLeft: '192px' }}>
          {/* Logo Section */}
          <Link href="/" data-testid="link-logo">
            <div className="cursor-pointer hover-elevate active-elevate-2 rounded-lg px-3 py-2 transition-all group" style={{ marginLeft: '-288px' }}>
              <img 
                src={rochvillesLogo} 
